...
# path to files
fn = 'data/raw/Electronics.json.gz'
...
sents_semeval_train, _, _ = semeval2014term_to_aspectsentiment_hr("data/raw/eng_test.xml")
sents_semeval_test, _, _ = semeval2014term_to_aspectsentiment_hr("data/raw/eng_train.xml")
